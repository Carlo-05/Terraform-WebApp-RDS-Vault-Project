...
o	Role-ID – like a username, usually known to the application.
o	Secret-ID – like a password, ideally short-lived and delivered securely.
...
*Note: For simplicity purposes, I hardcode the credentials. This is not the best practice!
Instead you can declare variables, then put the actual values in terraform.tfvars.*
